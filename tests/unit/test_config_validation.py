...
from asam.core.config import AsamConfig, ConfigValidator
...
class TestConfigValidator:
    ...
    def test_valid_config_validation(self):
        ...
        config_data = {
            ...
            "text_detection": {"enabled": True, "weight": 0.5},
    ...
    def test_invalid_confidence_threshold(self):
        ...
        config_data = {"detection": {"confidence_threshold": 1.5}}  # Invalid: > 1.0
...
class TestAsamConfig:
    ...
    def test_config_model_validation(self):
        ...
        # Valid config
        config = AsamConfig(
            detection={"confidence_threshold": 0.8}, text_detection={"weight": 0.4}
        )
